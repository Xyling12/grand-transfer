...
CMD rm -f /app/prisma/.db-ready && cp -f /app/prisma_backup/schema.prisma /app/prisma/schema.prisma && npx prisma db push && touch /app/prisma/.db-ready && node server.js
