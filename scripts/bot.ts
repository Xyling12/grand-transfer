...
const handleHelp = async (ctx: any) => {
    ...
    let msg = `🤖 <b>Справка по боту GrandTransfer (v1.3.3)</b>\n\n`;
    ...
    msg += `📌 <b>Обновление v1.3.3 (25.02.2026):</b>\n`;
